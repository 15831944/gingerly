...
var ChatApp = function ChatApp() {
  ...
  this.chatList = new _dom.ChatList(LIST_SELECTOR, 'snow');
...
var ChatMessage = function () {
  function ChatMessage(_ref) {
    var m = _ref.message,
        _ref$user = _ref.user,
        u = _ref$user === undefined ? 'anonymous' : _ref$user,
